...
output "vpc_flow_log_log_format" {
  description = "The logging format for the VPC Flow Logs"
  value       = module.vpc.vpc_flow_log_log_format
}

output "vpc_flow_log_max_aggregation_interval" {
  description = "The maximum aggregation interval for the VPC Flow Logs"
  value       = module.vpc.vpc_flow_log_max_aggregation_interval
}

output "network_acl_ingress_rules" {
  description = "Map of network ACL ingress rules with their configurations"
  value       = module.vpc.network_acl_ingress_rules
}

output "network_acl_egress_rules" {
  description = "Map of network ACL egress rules with their configurations"
  value       = module.vpc.network_acl_egress_rules
}
...
output "vpc_endpoints_security_group_rules" {
  description = "Security group rules for VPC endpoints"
  value       = module.vpc_endpoints.security_group_rules
}

output "vpc_endpoint_s3_policy_status" {
  description = "Status of the VPC endpoint policy for S3"
  value       = module.vpc_endpoints.endpoints["s3"].policy_status
}

output "vpc_endpoint_s3_encryption" {
  description = "Encryption configuration for S3 VPC endpoint"
  value       = module.vpc_endpoints.endpoints["s3"].encryption
}

output "vpc_endpoint_interface_policies" {
  description = "Map of VPC endpoint interface policies"
  value       = { for k, v in module.vpc_endpoints.endpoints : k => v.policy if v.vpc_endpoint_type == "Interface" }
}

output "vpc_endpoint_gateway_policies" {
  description = "Map of VPC endpoint gateway policies"
  value       = { for k, v in module.vpc_endpoints.endpoints : k => v.policy if v.vpc_endpoint_type == "Gateway" }
}